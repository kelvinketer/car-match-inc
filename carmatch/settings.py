...
import dj_database_url # <-- Added to connect to the Render PostgreSQL database
...
# UPDATED: The app will look for a cloud database first. 
# If it's running locally on your laptop, it will safely fall back to sqlite3.
DATABASES = {
