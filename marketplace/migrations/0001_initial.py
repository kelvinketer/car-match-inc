    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('plaid_access_token', models.CharField(blank=True, max_length=120, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('escrow_fee', models.DecimalField(decimal_places=2, default=99.0, max_digits=6)),
                ('status', models.CharField(choices=[('initiated', 'Initiated'), ('funds_secured', 'Funds Secured in Escrow'), ('handshake_pending', 'In-Person Handshake Pending'), ('completed', 'Transaction Completed & Title Transferred'), ('disputed', 'Disputed'), ('cancelled', 'Cancelled')], default='initiated', max_length=30)),
                ...
                ('vehicle', models.OneToOneField(on_delete=django.db.models.deletion.PROTECT, to='marketplace.vehicle')),
            ],
        ),
    ]
